...
4.  **Strict Serializability**: The Orchestrator enforces a total order of intents. Operation B is only processed after Operation A is finalized (Committed or Rolled Back). No interleaving of mutations is permitted.
