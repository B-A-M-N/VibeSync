...
## 5. Setting up Git for Success (Technical Hygiene)
To ensure VibeSync and your AI assistant can correctly attribute changes and maintain a clean audit log, you must configure your local git identity. This allows the system to distinguish between AI-generated changes and your own in the logs.

**Why?** The AI reads the git logs to understand the project history. If "User" is unknown, it creates ambiguity.

**Run these commands in your terminal (using your actual name/email):**
```bash
git config --global user.name "Your Name"
git config --global user.email "your@email.com"
# Optional: Setup a pretty log alias for easier reading
